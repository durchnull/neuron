...
class OrderAmazonPayCheckoutSessionUpdateAction extends OrderAction
{
    ...
    {
        $transaction = \App\Facades\Transaction::update($this->target, $this->validated['amazon_checkout_session_id'], []);
